...
func parseRigAgentAddress(bead *agentBead) string {
	...
	if roleType == constants.RoleWitness || roleType == constants.RoleRefinery || roleType == "librarian" {
		return rig + "/" + roleType
	}
...
func parseRigAgentAddressFromID(id string) string {
	...
	singletonRoles := []string{constants.RoleWitness, constants.RoleRefinery, "librarian"}
